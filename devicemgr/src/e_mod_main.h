...
#define XI_PROP_DEVICE_ENABLE "Device Enabled"
...
#define E_PROP_X_EVDEV_BUTTON_LABELS "Button Labels"
...
#define E_PROP_GAMEMODE_ENABLED "Game Mode Enabled"
#define E_PROP_MULTITOUCH_DEVICEID "MultitouchDeviceID"
#define E_PROP_PALM_DISABLING_WIN_RUNNING "Palm Disabling Window Running"
...
typedef struct _DeviceMgr_
{
   ...
   Ecore_X_Atom atomDeviceEnabled;
   Ecore_X_Atom atomRROutput;
   Ecore_X_Atom atomAxisLabels;
   Ecore_X_Atom atomButtonLabels;
   ...
   Ecore_X_Atom atomRelativeMoveAck;
   Ecore_X_Atom atomGameModeEnabled;
   Ecore_X_Atom atomMultitouchDeviceId;

   Ecore_X_Atom atomPalmDisablingWinRunning;
   Ecore_X_Window palmDisablingWin;
   Ecore_X_Atom atomPalmRejectionMode;
   ...
   Ecore_Event_Handler *window_destroy_handler;
   ...
   Ecore_X_Atom selection_type_atom;
   Eina_Bool selection_ownership;
   Ecore_X_Window selection_xwin;
   Ecore_X_Randr_Output selection_output_xid;
   char selection_prev_owner[256];
   Ecore_Event_Handler *selection_clear_handler;
   Ecore_Event_Handler *selection_request_handler;
   Ecore_Event_Handler *selection_notify_handler;
   Ecore_Timer *selection_request_timeout;
...
static void _e_devicemgr_xi2_device_property_handler(XIPropertyEvent *event);
...
static void _e_devicemgr_append_prop_touchscreen_device_id(int id);
static void _e_devicemgr_remove_prop_touchscreen_device_id(int id);
