...
E_Comp_Effect_Ani_Style
_effect_mod_pos_launch_type_get(const char *source)
{
   Ecore_X_Window xwin;
   int ang,x,y,w,h;
...
E_Comp_Effect_Ani_Style
_effect_mod_pos_close_type_get(const char *source)
{
   Ecore_X_Window xwin;
   int ang,x,y,w,h;
...
void
_effect_mod_pos_launch_make_emission(E_Comp_Win *cw, char *emission, int size)
{
   const char *sig = NULL;
   E_Zone *zone = NULL;
   E_Comp_Effect_Ani_Style ani_dep_angle;
...
void
_effect_mod_pos_close_make_emission(E_Comp_Win *cw, char *emission, int size)
{
   const char *sig = NULL;
   E_Zone *zone = NULL;
   E_Comp_Effect_Ani_Style ani_dep_angle;
