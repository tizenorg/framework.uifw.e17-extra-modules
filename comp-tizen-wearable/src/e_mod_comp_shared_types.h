   ...
   struct
     {
        ...
        E_Comp_Effect_Ani_Style      (*pos_launch_type_get)(const char *source);
        void                         (*pos_launch_make_emission)(E_Comp_Win *cw, char *emission, int size);
        E_Comp_Effect_Ani_Style      (*pos_close_type_get)(const char *source);
        void                         (*pos_close_make_emission)(E_Comp_Win *cw, char *emission, int size);
     }effect_funcs;
};
...
struct _E_Comp_Win
{
   ...
   E_Comp_Effect_Ani_Style     eff_launch_style; // animation type between win for launching
   E_Comp_Effect_Ani_Style     eff_close_style; // animation type between win for closing
   ...
   Eina_Bool                   skip_blend; // to copy img with the alpha (etc. in case of camera_preview)
