...
#define D *conf_edd
   ...
   E_CONFIG_VAL(D, T, effect_policy_app_callscreen, STR);
...
e_mod_comp_cfdata_config_new(void)
{
   ...
   cfg->effect_policy_normal = eina_stringshare_add("slide");
   ...
   cfg->effect_policy_app_callscreen = eina_stringshare_add("shadow_fade");
