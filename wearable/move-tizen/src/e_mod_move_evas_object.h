...
EINTERN E_Move_Evas_Object *e_mod_move_evas_plugin_obj_add(E_Move *m, E_Move_Canvas *canvas, const char *svcname);
...
EINTERN Eina_List          *e_mod_move_evas_plugin_objs_add(E_Move *m, const char *svcname);
