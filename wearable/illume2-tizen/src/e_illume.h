...
/**
 * W_WIN_CHECK is variable to do not iconify specific W window for W product feature
 */
#ifdef W_WIN_CHECK
EAPI Eina_Bool e_illume_border_is_w_launcher(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_shealth_exercise(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_w_indicator(E_Border *bd);
#endif
