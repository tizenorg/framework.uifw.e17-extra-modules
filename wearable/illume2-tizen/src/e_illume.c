...
#ifdef W_WIN_CHECK
EAPI Eina_Bool
e_illume_border_is_w_launcher(E_Border *bd)
{
   ...
   if ((bd->client.icccm.name) &&
       (!strcmp(bd->client.icccm.name, "w-launcher-app")))
     return EINA_TRUE;
...
EAPI Eina_Bool
e_illume_border_is_shealth_exercise(E_Border *bd)
{
   ...
   if ((bd->client.icccm.class) &&
       (!strcmp(bd->client.icccm.class, "shealth_exercise")))
     return EINA_TRUE;
...
EAPI Eina_Bool
e_illume_border_is_w_indicator(E_Border *bd)
{
   ...
   if ((bd->client.icccm.name) &&
       (!strcmp(bd->client.icccm.name, "windicator")))
     return EINA_TRUE;
...
e_illume_border_is_app_tray(E_Border *bd)
{
   ...
   if (name == NULL) return EINA_FALSE;
   if (strncmp(name,"com.samsung.app-tray",strlen("com.samsung.app-tray"))!= 0) return EINA_FALSE;
