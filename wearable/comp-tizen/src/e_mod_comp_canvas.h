...
EINTERN void                  e_mod_comp_layer_populate_above_normal(E_Comp_Layer *ly, Evas_Object *o);
EINTERN void                  e_mod_comp_layer_raise_above(E_Comp_Canvas *canvas, Evas_Object *o, E_Border *bd);
EINTERN void                  e_mod_comp_layer_lower_below(E_Comp_Canvas *canvas, Evas_Object *o, E_Border *bd);
