...
e_mod_comp_policy_init(void)
{
   ...
   eina_hash_add(shadow_hash, e_util_winid_str_get(E_COMP_WIN_TYPE_NORMAL),         "slide"       );
   eina_hash_add(shadow_hash, e_util_winid_str_get(E_COMP_WIN_TYPE_VIDEOCALL),       "shadow_fade"       );
   ...
   eina_hash_add(shadow_hash, e_util_winid_str_get(E_COMP_WIN_TYPE_APP_POPUP),      "dialog_without_dim");
   eina_hash_add(shadow_hash, e_util_winid_str_get(E_COMP_WIN_TYPE_APP_CALLSCREEN), "shadow_fade"       );
