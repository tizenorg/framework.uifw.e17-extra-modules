...
typedef enum _E_Comp_Win_Class_Type
{
   ...
   E_COMP_WIN_CLASS_TYPE_CALLSCREEN,
...
typedef enum _E_Comp_Win_Name_Type
{
   ...
   E_COMP_WIN_NAME_TYPE_CALLSCREEN,
   ...
   switch (ctype)
     {
      ...
      case E_COMP_WIN_CLASS_TYPE_SETUP_WIZARD:
         ...
         break;
      case E_COMP_WIN_CLASS_TYPE_CALLSCREEN:
         if (ntype == E_COMP_WIN_NAME_TYPE_CALLSCREEN)
           res = E_COMP_WIN_TYPE_APP_CALLSCREEN;
         break;
      default:
         break;
     }
