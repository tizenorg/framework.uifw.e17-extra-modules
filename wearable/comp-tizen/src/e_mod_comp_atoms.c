...
EINTERN Ecore_X_Atom ATOM_XV_USE                           = 0;
EINTERN Ecore_X_Atom ATOM_XV_PIXMAP0                       = 0;
EINTERN Ecore_X_Atom ATOM_XV_PIXMAP1                       = 0;
EINTERN Ecore_X_Atom ATOM_XV_BYPASS_TO_PIXMAP0             = 0;
EINTERN Ecore_X_Atom ATOM_XV_BYPASS_TO_PIXMAP1             = 0;
EINTERN Ecore_X_Atom ATOM_XV_BYPASS_DONE0                  = 0;
EINTERN Ecore_X_Atom ATOM_XV_BYPASS_DONE1                  = 0;
EINTERN Ecore_X_Atom ATOM_XV_ROT_EFFECT_DONE               = 0;
EINTERN Ecore_X_Atom ATOM_XV_ROT_EFFECT_BEGIN              = 0;
EINTERN Ecore_X_Atom ATOM_CM_TRANSPARENT_RECT              = 0;
EINTERN Ecore_X_Atom ATOM_RR_WM_STATE                      = 0;
