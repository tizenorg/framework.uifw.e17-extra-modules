...
EINTERN Eina_Bool                      e_mod_move_util_win_angle_get(Ecore_X_Window win, int *curr, int *prev);
...
EINTERN Eina_Bool                      e_mod_move_util_mouse_down_send(Ecore_X_Window id, unsigned int timestamp, int root_x, int root_y, int x, int y, int button);
EINTERN Eina_Bool                      e_mod_move_util_mouse_up_send(Ecore_X_Window id, unsigned int timestamp, int root_x, int root_y, int x, int y, int button);
EINTERN Eina_Bool                      e_mod_move_util_mouse_move_send(Ecore_X_Window id, unsigned int timestamp, int root_x, int root_y, int x, int y);
