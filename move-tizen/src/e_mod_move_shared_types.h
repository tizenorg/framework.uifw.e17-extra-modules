...
typedef enum _E_Move_Split_Mode_Indicator_State      E_Move_Split_Mode_Indicator_State;
...
#include "e_mod_move_split_mode_indicator_widget.h"
#include "e_mod_move_mini_apptray_widget.h"
#include "e_mod_move_split_launcher.h"
...
enum _E_Move_Split_Mode_Indicator_State
{
   E_MOVE_SPLIT_MODE_INDICATOR_STATE_NONE = 0,
   E_MOVE_SPLIT_MODE_INDICATOR_STATE_ON,
   E_MOVE_SPLIT_MODE_INDICATOR_STATE_OFF
};
...
struct _E_Move
{
   ...
   E_Move_Split_Mode_Indicator_Widget *split_mode_indicator_widget; // split_mode indicator widget data ( it contains widget object, internal data)
   ...
   Eina_Bool                           split_indicator_event_forwarding_disable : 1; // event forward to client window  enabled  or disabled
...
struct _E_Move_Border
{
   ...
   E_Move_Split_Mode_Indicator_State      split_mode_indicator_state; // Client Window's Split_Mode_Indicator Property State
