...
typedef enum _E_Move_Flick_Direction E_Move_Flick_Direction;

enum _E_Move_Flick_Direction
{
   E_MOVE_FLICK_UP = 0,
   E_MOVE_FLICK_DOWN
};
...
EINTERN Eina_Bool          e_mod_move_flick_data_move_pos_update(E_Move_Border *mb, int x, int y);
...
EINTERN Eina_Bool          e_mod_move_flick_scroll_cancel_state_get(E_Move_Border *mb, E_Move_Flick_Direction direction);
