...
#define GESTURE_DEVICE_ID "GESTURE_DEVICE_ID"
...
typedef struct _DeviceMgr_
{
   ...
   Ecore_X_Atom atomTouchRotationAngle;
   Ecore_X_Atom atomTouchRotationNode;
   Ecore_X_Atom atomTouchSwapAxes;
   Ecore_X_Atom atomTouchInvertAxes;
   Ecore_X_Atom atomGestureDeviceId;
...
static void _e_devicemgr_get_touch_rotation_node(int deviceid);
void _e_devicemgr_set_touch_rotation_angle(int deviceid, int angle);
...
Eina_Bool e_mod_sf_rotation_init(int touch_device_id);
