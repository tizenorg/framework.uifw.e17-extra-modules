...
static Eina_Bool _e_mod_policy_cb_border_hide(void *data __UNUSED__, int type __UNUSED__, void *event);
static Eina_Bool _e_mod_policy_cb_border_move(void *data __UNUSED__, int type __UNUSED__, void *event);
static Eina_Bool _e_mod_policy_cb_border_resize(void *data __UNUSED__, int type __UNUSED__, void *event);
...
static Eina_Bool _e_mod_policy_cb_border_comp_src_visibility(void *data __UNUSED__, int type __UNUSED__, void *event);
static Eina_Bool _e_mod_policy_cb_border_rotation_change_end(void *data __UNUSED__, int type __UNUSED__, void *event);
static Eina_Bool _e_mod_policy_cb_border_desk_layout_set_end(void *data __UNUSED__, int type __UNUSED__, void *event);
static Eina_Bool _e_mod_policy_cb_border_rotation_change_begin(void *data __UNUSED__, int type __UNUSED__, void *event);
static Eina_Bool _e_mod_policy_cb_zone_move_resize(void *data __UNUSED__, int type __UNUSED__, void *event);
static Eina_Bool _e_mod_policy_cb_zone_rotation_change_begin(void *data __UNUSED__, int type __UNUSED__, void *event);
...
static void _e_mod_policy_cb_hook_eval_end(void *data __UNUSED__, void *data2);

#ifdef _F_BORDER_HOOK_PATCH_
static void _e_mod_policy_cb_hook_del_border(void *data __UNUSED__, void *data2);
#endif

static void _e_mod_policy_cb_hook_border_desktop_layout_pre_show_set(void *data __UNUSED__, void *data2);
static void _e_mod_policy_cb_hook_border_desktop_layout_pre_hide_set(void *data __UNUSED__, void *data2);
static void _e_mod_policy_cb_hook_border_aux_hint_eval(void *data __UNUSED__, void *data2);
...
static Eina_Bool _e_mod_policy_cb_module_init_end(void *d __UNUSED__, int type __UNUSED__, void *ev __UNUSED__);
...
E_DBus_Connection *dbus_conn = NULL;
...
_e_mod_policy_handlers_add(void)
{
   ...
   _policy_hdls =
     eina_list_append(_policy_hdls,
                      ecore_event_handler_add(E_EVENT_BORDER_RESIZE,
                                              _e_mod_policy_cb_border_resize,
                                              NULL));
   _policy_hdls =
     eina_list_append(_policy_hdls,
                      ecore_event_handler_add(E_EVENT_COMP_SOURCE_VISIBILITY,
                                              _e_mod_policy_cb_border_comp_src_visibility,
                                              NULL));
   _policy_hdls =
     eina_list_append(_policy_hdls,
                      ecore_event_handler_add(E_EVENT_BORDER_ROTATION_CHANGE_END,
                                              _e_mod_policy_cb_border_rotation_change_end,
                                              NULL));

   _policy_hdls =
     eina_list_append(_policy_hdls,
                      ecore_event_handler_add(E_EVENT_BORDER_DESK_LAYOUT_SET_END,
                                              _e_mod_policy_cb_border_desk_layout_set_end,
                                              NULL));
   _policy_hdls =
     eina_list_append(_policy_hdls,
                      ecore_event_handler_add(E_EVENT_BORDER_ROTATION_CHANGE_BEGIN,
                                              _e_mod_policy_cb_border_rotation_change_begin,
                                              NULL));
   _policy_hdls =
     eina_list_append(_policy_hdls,
   ...
   _policy_hdls =
     eina_list_append(_policy_hdls,
                      ecore_event_handler_add(E_EVENT_ZONE_ROTATION_CHANGE_BEGIN,
                                              _e_mod_policy_cb_zone_rotation_change_begin,
                                              NULL));
   _policy_hdls =
     eina_list_append(_policy_hdls,
   ...
   _policy_hdls =
     eina_list_append(_policy_hdls,
                      ecore_event_handler_add(E_EVENT_MODULE_INIT_END,
                                              _e_mod_policy_cb_module_init_end,
                                              NULL));
}
...
_e_mod_policy_hooks_add(void)
{
   ...
   _policy_hooks =
     eina_list_append(_policy_hooks,
                      e_border_hook_add(E_BORDER_HOOK_POST_NEW_BORDER,
                                        _e_mod_policy_cb_hook_new_border, NULL));
   _policy_hooks =
     eina_list_append(_policy_hooks,
                      e_border_hook_add(E_BORDER_HOOK_EVAL_END,
                                        _e_mod_policy_cb_hook_eval_end, NULL));
#ifdef _F_BORDER_HOOK_PATCH_
   _policy_hooks =
     eina_list_append(_policy_hooks,
   ...
   _policy_hooks =
     eina_list_append(_policy_hooks,
                      e_border_hook_add(E_BORDER_HOOK_DESKTOP_LAYOUT_PRE_SHOW_SET,
                                        _e_mod_policy_cb_hook_border_desktop_layout_pre_show_set, NULL));
   _policy_hooks =
     eina_list_append(_policy_hooks,
                      e_border_hook_add(E_BORDER_HOOK_DESKTOP_LAYOUT_PRE_HIDE_SET,
                                        _e_mod_policy_cb_hook_border_desktop_layout_pre_hide_set, NULL));
   _policy_hooks =
     eina_list_append(_policy_hooks,
                      e_border_hook_add(E_BORDER_HOOK_AUX_HINT_EVAL,
                                        _e_mod_policy_cb_hook_border_aux_hint_eval, NULL));
}
...
static Eina_Bool
_e_mod_policy_cb_border_hide(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   E_Event_Border_Hide *ev;

   ev = event;
   if ((_policy) && (_policy->funcs.border_hide))
     _policy->funcs.border_hide(ev->border);
...
static Eina_Bool
_e_mod_policy_cb_border_resize(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   E_Event_Border_Resize *ev;

   ev = event;
   if ((_policy) && (_policy->funcs.border_resize))
     _policy->funcs.border_resize(ev->border);

   return ECORE_CALLBACK_PASS_ON;
}

static Eina_Bool
_e_mod_policy_cb_border_comp_src_visibility(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   E_Border *bd = NULL;
   ...
   if ((_policy) && (_policy->funcs.border_comp_src_visibility))
     _policy->funcs.border_comp_src_visibility(bd, ev->visible);
...
static Eina_Bool
_e_mod_policy_cb_zone_rotation_change_begin(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   E_Event_Zone_Rotation_Change_Begin *ev = event;
   E_Zone *zone = ev->zone;

   if ((_policy) && (_policy->funcs.zone_rotation_change_begin))
     _policy->funcs.zone_rotation_change_begin(zone);
...
_e_mod_policy_cb_client_message(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   ...
   if (ev->message_type == ECORE_X_ATOM_NET_ACTIVE_WINDOW)
     ...
     {
        if ((_policy) && (_policy->funcs.illume_internal))
          _policy->funcs.illume_internal(ev);
     }
...
static Eina_Bool
_e_mod_policy_cb_border_rotation_change_end(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   E_Event_Border_Rotation_Change_End *ev = event;
   E_Border *bd = ev->border;

   if ((_policy) && (_policy->funcs.border_rotation_change_end))
     _policy->funcs.border_rotation_change_end(bd);

   return ECORE_CALLBACK_PASS_ON;
}

static Eina_Bool
_e_mod_policy_cb_border_desk_layout_set_end(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   E_Event_Border_Desk_Layout_Set_End *ev = event;
   E_Border *bd = ev->border;
   int show = ev->show;

   if ((_policy) && (_policy->funcs.border_desk_layout_set_end))
     _policy->funcs.border_desk_layout_set_end(bd, show);

   return ECORE_CALLBACK_PASS_ON;
}

static Eina_Bool
_e_mod_policy_cb_border_rotation_change_begin(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   E_Event_Border_Rotation_Change_Begin *ev = event;
   E_Border *bd = ev->border;

   if ((_policy) && (_policy->funcs.border_rotation_change_begin))
     _policy->funcs.border_rotation_change_begin(bd);
...
static void
_e_mod_policy_cb_hook_eval_end(void *data __UNUSED__, void *data2)
{
   E_Border *bd;

   if (!(bd = data2)) return;
   if ((_policy) && (_policy->funcs.border_eval_end))
     _policy->funcs.border_eval_end(bd);
}
...
static void
_e_mod_policy_cb_hook_border_desktop_layout_pre_show_set(void *data __UNUSED__, void *data2)
{
   E_Border *bd;

   if (!(bd = data2)) return;
   if ((_policy) && (_policy->funcs.border_desktop_layout_pre_show_set))
     _policy->funcs.border_desktop_layout_pre_show_set(bd);
}

static void
_e_mod_policy_cb_hook_border_desktop_layout_pre_hide_set(void *data __UNUSED__, void *data2)
{
   E_Border *bd;

   if (!(bd = data2)) return;
   if ((_policy) && (_policy->funcs.border_desktop_layout_pre_hide_set))
     _policy->funcs.border_desktop_layout_pre_hide_set(bd);
}

static void
_e_mod_policy_cb_hook_border_aux_hint_eval(void *data __UNUSED__, void *data2)
{
   E_Border *bd;

   if (!(bd = data2)) return;
   if ((_policy) && (_policy->funcs.border_aux_hint_eval))
     _policy->funcs.border_aux_hint_eval(bd);
}

static Eina_Bool
_e_mod_policy_cb_module_init_end(void *d __UNUSED__, int type __UNUSED__, void *ev __UNUSED__)
{
   /* initialize EDbus */
   if(_e_illume_cfg->dbus.use)
     {
        ...
        if (!dbus_conn)
          {
             printf("Failed initializing dbus connection\n");
             e_dbus_shutdown();
          }
     }
