   ...
   if (ret && prop_data)
     {
        ...
        if      (_e_illume_logger_type == LT_NOTHING) fprintf(stdout, "LT_NOTHING ");
        ...
        else
          {
             ...
             if ((_e_illume_logger_type & LT_SCREEN_LOCK) == LT_SCREEN_LOCK) fprintf(stdout, "LT_SCREEN_LOCK, ");
             ...
             if ((_e_illume_logger_type & LT_VISIBILITY_DETAIL) == LT_VISIBILITY_DETAIL) fprintf(stdout, "LT_VISIBILITY_DETAIL, ");
             if ((_e_illume_logger_type & LT_FLOATING) == LT_FLOATING) fprintf(stdout, "LT_FLOATING, ");
             if ((_e_illume_logger_type & LT_ASSISTANT_MENU) == LT_ASSISTANT_MENU) fprintf(stdout, "LT_ASSISTANT_MENU, ");
          }
