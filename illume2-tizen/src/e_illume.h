   ...
   struct
     {
        ...
        void (*border_hide) (E_Border *bd);
        /**< pointer to the function that Illume will call when a border gets
         * hidden. @note This function is optional. */

        void (*border_move) (E_Border *bd);
        /**< pointer to the function that Illume will call when a border gets
         * moved. */

        void (*border_resize) (E_Border *bd);
        /**< pointer to the function that Illume will call when a border gets
         * resized. */

        void (*border_comp_src_visibility) (E_Border *bd, Eina_Bool visible);
        /**< pointer to the function that Illume will call when a border gets
         * comp_src_visibility changed. @note This function is optional. */

        void (*border_rotation_change_begin) (E_Border *bd);
        /**< pointer to the function that Illume will call when a border gets
         * rotation change begin. @note This function is optional. */

        void (*border_rotation_change_end) (E_Border *bd);
        /**< pointer to the function that Illume will call when a border gets
         * rotation change ended. @note This function is optional. */

        void (*border_desk_layout_set_end) (E_Border *bd, int show);
        /**< pointer to the function that Illume will call when a border gets
         * desk layout set ended. @note This function is optional. */
        ...
        void (*zone_rotation_change_begin) (E_Zone *zone);
        /**< pointer to the function that Illume will call when a Zone gets
         * change begin. @note This function is optional. */
        ...
        void (*border_eval_end) (E_Border *bd);
        ...
        void (*illume_internal) (Ecore_X_Event_Client_Message *event);

        void (*border_desktop_layout_pre_show_set) (E_Border *bd);
        void (*border_desktop_layout_pre_hide_set) (E_Border *bd);
        void (*border_aux_hint_eval) (E_Border *bd);
     } funcs;
};
...
struct _E_Illume_Config
{
   ...
   Eina_Bool use_screen_lock;
   double timeout_screen_lock;
   ...
   struct
     {
        ...
        struct
          {
             /**< use dbus msg to wake up freezed(iconified) window by processmgr. */
             Eina_Bool use_unfreeze_win;
...
EAPI Eina_Bool e_illume_border_is_floating(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_assistant_menu(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_icon_win(E_Border *bd);
...
/* etc */
EAPI Eina_Bool e_illume_border_is_toast_popup(E_Border *bd);
...
EAPI Eina_Bool e_illume_border_is_split_launcher(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_split_launcher_drag(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_split_launcher_welcome(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_mini_app_launcher(E_Border *bd);

EAPI Eina_Bool e_illume_border_is_home_screen(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_volume(E_Border *bd);
EAPI Eina_Bool e_illume_border_is_cpuinfo(E_Border *bd);
#endif
