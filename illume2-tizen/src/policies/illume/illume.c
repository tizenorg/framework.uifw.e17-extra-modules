...
e_illume_policy_init(E_Illume_Policy *p)
{
   ...
   p->funcs.border_desk_layout_set_end = _policy_border_cb_desk_layout_set_end;
   ...
   p->funcs.border_desktop_layout_pre_show_set = NULL;
   p->funcs.border_desktop_layout_pre_hide_set = NULL;
   p->funcs.border_aux_hint_eval = _policy_border_hook_aux_hint_eval;
...
e_illume_policy_shutdown(E_Illume_Policy *p)
{
   ...
   p->funcs.border_desk_layout_set_end = NULL;
   ...
   p->funcs.border_desktop_layout_pre_show_set = NULL;
   p->funcs.border_desktop_layout_pre_hide_set = NULL;
   p->funcs.border_aux_hint_eval = NULL;
