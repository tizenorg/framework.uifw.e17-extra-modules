...
e_illume_border_is_clipboard(E_Border *bd)
{
   ...
   if (!strncmp(title,
                ...
                strlen("Clipboard History Manager")))
     return EINA_TRUE;
...
e_illume_border_is_app_tray(E_Border *bd)
{
   ...
   if (clas == NULL) return EINA_FALSE;
   if (strncmp(clas,"app-tray",strlen("app-tray"))!= 0) return EINA_FALSE;
   if (name == NULL) return EINA_FALSE;
   if (strncmp(name,"org.tizen.app-tray",strlen("org.tizen.app-tray"))!= 0) return EINA_FALSE;

   return EINA_TRUE;
}

EAPI Eina_Bool
e_illume_border_is_toast_popup(E_Border *bd)
{
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (name == NULL) return EINA_FALSE;
   if (strncmp(name,"TOAST_POPUP", strlen("TOAST_POPUP"))!= 0) return EINA_FALSE;
...
EAPI Eina_Bool
e_illume_border_is_floating(E_Border *bd)
{
   unsigned int state;
   ...
   state = bd->client.illume.win_state.state;
...
EAPI Eina_Bool
e_illume_border_is_assistant_menu(E_Border *bd)
{
   unsigned int state;
   Eina_Bool ret = EINA_FALSE;
   ...
   state = bd->client.illume.win_state.state;
   if (state == ECORE_X_ILLUME_WINDOW_STATE_ASSISTANT_MENU)
     ret = EINA_TRUE;
...
EAPI Eina_Bool
e_illume_border_is_icon_win(E_Border *bd)
{
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (clas == NULL) return EINA_FALSE;
   if (strncmp(clas,"ICON_WIN", strlen("ICON_WIN"))!= 0) return EINA_FALSE;
   if (name == NULL) return EINA_FALSE;
   if (strncmp(name,"E", strlen("E"))!= 0) return EINA_FALSE;
...
EAPI Eina_Bool
e_illume_border_is_split_launcher(E_Border *bd)
{
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (strncmp(clas,"SPLIT_LAUNCHER", strlen("SPLIT_LAUNCHER"))!= 0) return EINA_FALSE;
   if (strncmp(name,"SPLIT_LAUNCHER", strlen("SPLIT_LAUNCHER"))!= 0) return EINA_FALSE;

   return EINA_TRUE;
}

EAPI Eina_Bool
e_illume_border_is_split_launcher_drag(E_Border *bd)
{
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (!clas) return EINA_FALSE;
   if (!name) return EINA_FALSE;
   if (strncmp(clas,"split-launcher,", strlen("split-launcher"))!= 0) return EINA_FALSE;
   if (strncmp(name,"Drag", strlen("Drag"))!= 0) return EINA_FALSE;

   return EINA_TRUE;
}

EAPI Eina_Bool
e_illume_border_is_split_launcher_welcome(E_Border *bd)
{
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (!name) return EINA_FALSE;
   if (strncmp(clas,"split-launcher,", strlen("split-launcher"))!= 0) return EINA_FALSE;
   if (strncmp(name,"Welcome", strlen("Welcome"))!= 0) return EINA_FALSE;

   return EINA_TRUE;
}

EAPI Eina_Bool e_illume_border_is_mini_app_launcher(E_Border *bd)
{
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (!clas) return EINA_FALSE;
   if (!name) return EINA_FALSE;
   if (strncmp(clas,"org.tizen.mini-apps", strlen("org.tizen.mini-apps"))!= 0) return EINA_FALSE;
   if (strncmp(name,"org.tizen.mini-apps", strlen("org.tizen.mini-apps"))!= 0) return EINA_FALSE;

   return EINA_TRUE;
}

EAPI Eina_Bool
e_illume_border_is_home_screen(E_Border *bd)
{
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (!clas) return EINA_FALSE;
   if (!name) return EINA_FALSE;
   if (strncmp(clas,"LIVE_MAGAZINE", strlen("LIVE_MAGAZINE"))!= 0) return EINA_FALSE;
...
EAPI Eina_Bool
e_illume_border_is_volume(E_Border *bd)
{
   ...
   if (!title) return EINA_FALSE;
   if (!clas) return EINA_FALSE;
   if (!name) return EINA_FALSE;

   if (strncmp(title,"volume", strlen("volume"))!= 0) return EINA_FALSE;
   if (strncmp(clas,"SYSTEM_POPUP", strlen("SYSTEM_POPUP"))!= 0) return EINA_FALSE;
   if (strncmp(name,"SYSTEM_POPUP", strlen("SYSTEM_POPUP"))!= 0) return EINA_FALSE;
...
EAPI Eina_Bool
e_illume_border_is_cpuinfo(E_Border *bd)
{
   const char *title = NULL;
   const char *name = NULL;
   const char *clas = NULL;
   ...
   if (strncmp(title,"DEBUGGING_INFO", strlen("DEBUGGING_INFO"))!= 0) return EINA_FALSE;
   if (strncmp(clas,"DEBUGGING_INFO", strlen("DEBUGGING_INFO"))!= 0) return EINA_FALSE;
   if (strncmp(name,"settings", strlen("settings"))!= 0) return EINA_FALSE;
