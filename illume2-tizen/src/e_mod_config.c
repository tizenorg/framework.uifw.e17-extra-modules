...
#define D _il_conf_edd
   ...
   E_CONFIG_VAL(D, T, use_screen_lock, UCHAR);
   E_CONFIG_VAL(D, T, timeout_screen_lock, DOUBLE);
   E_CONFIG_VAL(D, T, dbus.use, UCHAR);
   E_CONFIG_VAL(D, T, dbus.rscd_msg.use_unfreeze_win, UCHAR);
   E_CONFIG_VAL(D, T, dbus.rscd_msg.path, STR);
   E_CONFIG_VAL(D, T, dbus.rscd_msg.iface, STR);
   E_CONFIG_VAL(D, T, dbus.rscd_msg.sig_name, STR);
...
_e_mod_illume_config_new(void)
{
   ...
   _e_illume_cfg->use_screen_lock = EINA_FALSE;
   _e_illume_cfg->timeout_screen_lock = 2.5;

   _e_illume_cfg->dbus.use = 0;
   _e_illume_cfg->dbus.rscd_msg.use_unfreeze_win = 0;
   _e_illume_cfg->dbus.rscd_msg.path = eina_stringshare_add("/Org/Tizen/ResourceD/Process");
   _e_illume_cfg->dbus.rscd_msg.iface = eina_stringshare_add("org.tizen.resourced.process");
   _e_illume_cfg->dbus.rscd_msg.sig_name = eina_stringshare_add("ProcStatus");
