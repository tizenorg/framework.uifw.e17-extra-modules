...
# define POL_NUM_OF_LAYER 11

/* define layer values here so we don't have to grep through code to change */
/* layer level 11 (500~) */
# define POL_CPUINFOL_LAYER 500
# define POL_ASSISTANT_MENU_LAYER 500

/* layer level 10 (450~500) */
# define POL_QUICKPANEL_LAYER 450
# define POL_VOLUME_LAYER 450
# define POL_TOAST_POPUP_LAYER 450
...
# define POL_FLOATING_LAYER 200
# define POL_SPLIT_LAUNCHER_LAYER 200
...
/* external variable to edbus connection */
