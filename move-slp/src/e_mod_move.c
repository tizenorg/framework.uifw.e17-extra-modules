...
_e_mod_move_add(E_Manager *man)
{
   ...
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].x
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].x;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].y
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].y;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].w
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].w;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].h
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_0].h;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].x
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].x;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].y
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].y;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].w
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].w;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].h
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_90].h;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].x
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].x;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].y
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].y;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].w
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].w;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].h
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_180].h;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].x
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].x;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].y
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].y;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].w
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].w;
   m->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].h
      = _move_mod->conf->indicator_widget_geometry[E_MOVE_INDICATOR_WIDGET_ANGLE_270].h;
