...
_motion_info_free(E_Move_Event_Motion_Info *motion)
{
   ...
   if (motion->event_info)
     {
        memset(motion->event_info, 0, sizeof(motion->event_info));
   ...
   if ((m) && (m->ev_log))
     {
        ...
        E_Move_Border *mb = (E_Move_Border *)(ev->fn[E_MOVE_EVENT_TYPE_MOTION_START].data);
   ...
   if ((m) && (m->ev_log))
     {
        ...
        E_Move_Border *mb = (E_Move_Border *)(ev->fn[E_MOVE_EVENT_TYPE_MOTION_END].data);
