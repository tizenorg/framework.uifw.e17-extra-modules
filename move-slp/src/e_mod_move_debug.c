                                          ...
                                          FILE   *fs)
{
   ...
   fprintf(fs, "\n\nB------------------------------------------------------------------------------------------------\n");
   fprintf(fs, "   <MOVE MODULE>  VISIBILITY / INDICATOR_STATE  Info\n");
   fprintf(fs, "-------------------------------------------------------------------------------------------------\n");
   fprintf(fs, "  NO   BORDER  CLIENT_WIN | V | VISIBILITY_STATE | INDICATOR_STATE | PID  WNAME / WCLASS\n");
   fprintf(fs, "-------------------------------------------------------------------------------------------------\n");
   ...
   EINA_INLIST_REVERSE_FOREACH(m->borders, mb)
     {
        ...
        fprintf(fs,
                " %3d 0x%07x %9s | %2s | %16.16s | %15.15s | %4d %s / %s\n",
                i,
                bid,
                buf,
                mb->visible ? "v" : " ",
